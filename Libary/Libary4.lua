...
NotifHolder.Position = UDim2.new(0.5, 0, 0, 0)
NotifHolder.Size = UDim2.new(0, 360, 0, 600)
...
function FireLib4:Window(text, bottom,mainclr,toclose)
	...
	MainCorner.CornerRadius = FireLib4.CornerRadius
	...
	LeftCorner.CornerRadius = FireLib4.CornerRadius
	...
	SettingsGear.MouseButton1Click:Connect(function()
		...
		SettingsPanel:TweenSize(UDim2.new(0, 240, 0, targetH), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, 0.35, true)
	end)
	...
	function Tabs:Tab(text,ico)
		...
		function ContainerContent:Button(text, desc, keybind, callback)
			...
			ButtonCorner.CornerRadius = FireLib4.CornerRadius
		...
		function ContainerContent:Toggle(text, desc,default, callback)
			...
			ToggleCorner.CornerRadius = FireLib4.CornerRadius
		...
		function ContainerContent:Slider(text,desc,min,max,start,callback)
			...
			SliderCorner.CornerRadius = FireLib4.CornerRadius
		...
		function ContainerContent:Dropdown(text,list,callback)
			...
			DropdownCorner.CornerRadius = FireLib4.CornerRadius
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			ColorpickerCorner.CornerRadius = FireLib4.CornerRadius
			...
			ConfirmCorner.CornerRadius = FireLib4.CornerRadius
			...
			BoxColorCorner.CornerRadius = FireLib4.CornerRadius
		...
		function ContainerContent:Line()
			...
			LineCorner.CornerRadius = FireLib4.CornerRadius
		...
		function ContainerContent:Label(text)
			...
			LabelCorner.CornerRadius = FireLib4.CornerRadius
		...
		function ContainerContent:Textbox(text,desc,disapper,callback)
			...
			TextboxCorner.CornerRadius = FireLib4.CornerRadius
			...
			TextboxFrameCorner.CornerRadius = FireLib4.CornerRadius
