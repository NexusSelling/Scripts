...
coroutine.wrap(
    function()
        while wait() do
            FireLib4.RainbowColorValue = FireLib4.RainbowColorValue + 1 / 255
            FireLib4.HueSelectionPosition = FireLib4.HueSelectionPosition + 1

            if FireLib4.RainbowColorValue >= 1 then
                FireLib4.RainbowColorValue = 0
            end

            if FireLib4.HueSelectionPosition == 80 then
                FireLib4.HueSelectionPosition = 0
            end
        end
    end
)()
...
function FireLib4:Window(text, bottom,mainclr,toclose)
    ...
    MainFrame:TweenSize(UDim2.new(0, 706, 0, 484), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
        ...
        function(io, p)
            if io.KeyCode == CloseBind then
                if uitoggled == false then
                    MainFrame:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                    uitoggled = true
                    wait(.5)
    ...
    function FireLib4:Notification(desc,buttontitle)
        ...
        NotificationFrame.Parent = NotifHolder
        ...
        NotificationTitle.Size = UDim2.new(0, 200, 0, 20)
        ...
        NotificationDesc.Position = UDim2.new(0, 15, 0, 35)
        NotificationDesc.Size = UDim2.new(1, -30, 0, 40)
        ...
        CloseBtn.MouseEnter:Connect(function()
            TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
        end)
        CloseBtn.MouseLeave:Connect(function()
            TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 0.3}):Play()
        end)
        ...
        local function CloseNotification()
            ...
            closed = true
            TweenService:Create(NotificationDesc, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 1}):Play()
            TweenService:Create(NotificationTitle, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 1}):Play()
            TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 1, BackgroundTransparency = 1}):Play()
            TweenService:Create(NotificationFrame, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {BackgroundTransparency = 1}):Play()
            wait(.3)
            NotificationFrame:TweenSize(UDim2.new(1, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .3, true)
            wait(.3)
        ...
        wait(.3)
        TweenService:Create(NotificationDesc, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 0.3}):Play()
        TweenService:Create(CloseBtn, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 0.3, BackgroundTransparency = 0}):Play()
        TweenService:Create(NotificationTitle, TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
    end
    local Tabs = {}
        ...
        function ContainerContent:Button(text, desc, keybind, callback)
            ...
            ArrowBtn.MouseButton1Click:Connect(function()
                    if BtnDescToggled == false then
                        Button:TweenSize(UDim2.new(0, 457, 0, 74), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                        ...
                        Button:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
        ...
        function ContainerContent:Toggle(text, desc,default, callback)
            ...
            Toggle.MouseButton1Click:Connect(function()
                    if Toggled == false then
                        ToggleCircle:TweenPosition(UDim2.new(0.37, 0,-0.273, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .3, true)
                        TweenService:Create(
                            ToggleCircle,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {BackgroundColor3 =PresetColor}
                        ...
                        ToggleCircle:TweenPosition(UDim2.new(0, 0,-0.273, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .3, true)
                        TweenService:Create(
                            ToggleCircle,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
            ...
            ArrowBtn.MouseButton1Click:Connect(function()
                    if ToggleDescToggled == false then
                        Toggle:TweenSize(UDim2.new(0, 457, 0, 74), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = PresetColor}
                        ...
                        Toggle:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(255,255,255)}
        ...
        function ContainerContent:Slider(text,desc,min,max,start,callback)
            ...
            ArrowBtn.MouseButton1Click:Connect(function()
                    if SliderDescToggled == false then
                        Slider:TweenSize(UDim2.new(0, 457, 0, 101), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = PresetColor}
                        ...
                        Slider:TweenSize(UDim2.new(0, 457, 0, 60), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(255,255,255)}
        ...
        function ContainerContent:Dropdown(text,list,callback)
            ...
            Dropdown.MouseButton1Click:Connect(function()
                    if DropToggled == false then
                        Title.Text = Selected
                        Dropdown:TweenSize(UDim2.new(0, 457, 0, FrameSize), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = PresetColor}
                        ...
                        Title.Text = Selected
                        Dropdown:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(255,255,255)}
        ...
        function ContainerContent:Colorpicker(text,preset,callback)
            ...
            ColorpickerBtn.MouseButton1Click:Connect(function()
                    if ColorPickerToggled == false then
                        ...
                        Colorpicker:TweenSize(UDim2.new(0, 457, 0, 138), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = PresetColor}
                        ...
                        ColorSelection.Visible = false
                        HueSelection.Visible = false
                        Colorpicker:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(255,255,255)}
                ...
                function()
                    ...
                    if RainbowColorPicker then
                        ...
                        while RainbowColorPicker do
                            BoxColor.BackgroundColor3 = Color3.fromHSV(FireLib4.RainbowColorValue, 1, 1)
                            Color.BackgroundColor3 = Color3.fromHSV(FireLib4.RainbowColorValue, 1, 1)

                            ColorSelection.Position = UDim2.new(1, 0, 0, 0)
                            HueSelection.Position = UDim2.new(0.48, 0, 0, FireLib4.HueSelectionPosition)
        ...
        function ContainerContent:Textbox(text,desc,disapper,callback)
            ...
            ArrowBtn.MouseButton1Click:Connect(function()
                    if TextboxDescToggled == false then
                        Textbox:TweenSize(UDim2.new(0, 457, 0, 81), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = PresetColor}
                        ...
                        Textbox:TweenSize(UDim2.new(0, 457, 0, 43), Enum.EasingDirection.Out, Enum.EasingStyle.Cubic, .6, true)
                        TweenService:Create(
                            Title,
                            TweenInfo.new(.3, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out),
                            {TextColor3 = Color3.fromRGB(255,255,255)}
